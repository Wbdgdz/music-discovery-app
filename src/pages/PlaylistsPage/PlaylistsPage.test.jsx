...
describe('PlaylistsPage', () => {
    ...
    test('renders playlists page', async () => {
        ...
        // should render heading of level 2 showing total playlist count (dynamic)
    ...
    test('verify styling and accessibility attributes using role', async () => {
        ...
        // should have heading level 2 with appropriate class name and dynamic count
        const heading2 = screen.getByRole('heading', { level: 2, name: `${playlistsData.items.length} Playlists` });
